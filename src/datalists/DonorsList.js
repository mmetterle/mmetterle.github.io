...
import ModalButton from './ModalButton';
	...
	var DONOR_COLUMNS = [
		{label: "Donor", classname:"col-lg-3 col-md-6", tableIndex: "1", ariaControls: "dataTables-example", ariaLabel:"Rendering engine: activate to sort column descending", rowspan: "1", colspan:"1", width: 265 },
	...
	render() {
		...
		return (
			...
			<div className="col-lg-12"> 
				<PageHeader>Donors List</PageHeader> 
				<Panel header="Panel heading without title">
					<ModalButton/>
					{' '}
					<div className="dataTable_wrapper">
						<TableComponent columns={DONOR_COLUMNS} rows={DONOR_ROWS}/>
					</div>
				</Panel>
				<div className="row">
